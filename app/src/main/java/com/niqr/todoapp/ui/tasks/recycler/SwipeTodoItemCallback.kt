...
class SwipeTodoItemCallback(
    ...
    private val acceptIcon = AppCompatResources.getDrawable(applicationContext, R.drawable.ic_baseline_check_24dp)!!.toBitmap()
    private val deleteIcon = AppCompatResources.getDrawable(applicationContext, R.drawable.ic_baseline_delete_24dp)!!.toBitmap()
